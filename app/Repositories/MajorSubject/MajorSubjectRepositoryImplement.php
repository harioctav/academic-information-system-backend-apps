...
class MajorSubjectRepositoryImplement extends Eloquent implements MajorSubjectRepository
{
  /**
   * Model class to be used in this repository for the common methods inside Eloquent
   * Don't remove or change $this->model variable name
   */
  protected MajorSubject $model;

  public function __construct(MajorSubject $model)
  {
    $this->model = $model;
  }
